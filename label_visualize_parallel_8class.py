...
# Define constants
# BASE_PATH = "/mnt/data/sibo/chile_remote_videos/data_annotation/829_annotation/train/"
# BASE_PATH = "/mnt/data/sibo/GP45/202305/"
BASE_PATH = "/mnt/data/sibo/GP45/20230906-13/cabin/"
INPUT_FOLDER = os.path.join(BASE_PATH, 'images/')
OUTPUT_FOLDER = os.path.join(BASE_PATH, 'dino_8class/')
DATA_YAML_PATH = os.path.join(OUTPUT_FOLDER, 'data.yaml')
ontology_dict = {"person": "person", "car": "car", "truck": "truck", "cell phone": "cell phone", "Traffic cone": "cone", "helmet": "helmet", "machinery vehicle": "machinery vehicle", "hook": "hook"}
